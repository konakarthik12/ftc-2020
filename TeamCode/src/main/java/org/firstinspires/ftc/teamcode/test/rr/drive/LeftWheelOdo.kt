...
*/
@Config
class LeftWheelOdo(hardwareMap: HardwareMap, val imu: BNO055IMU) : TwoTrackingWheelLocalizer(listOf(
...
//        val right = leftEncoder.motor.currentPosition*
        return listOf(
                leftEncoder.motor.currentPosition,
//                rightEncoder.motor.currentPosition,
                0*    strafeEncoder.motor.currentPosition
        )
...
//                rightEncoder.motor.currentPosition / RIGHT_SCALAR,
                0*strafeEncoder.motor.currentPosition / STRAFE_SCALAR
        )
...
//                rightEncoder.motor.velocity / RIGHT_SCALAR,
               0* strafeEncoder.motor.velocity / STRAFE_SCALAR
        )
    }

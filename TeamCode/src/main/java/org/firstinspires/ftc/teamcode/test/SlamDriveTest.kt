...
//        val cameraPose = findCameraTrans(robot.slam.transHandler.cameraInitialTrans, robot.slam.getRawTrans()) //takes in 3 calculated constants, and 3 values (camera init pc.getPose and values from SLAM cam)
